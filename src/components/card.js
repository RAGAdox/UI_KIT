...
const CardWithDescription = ({
  ...
  return (
    <div
      className="bg-gray-50 lg:mt-8 rounded-xl shadow-lg sm:max-w-xs mx-auto
    ...
    >
      ...
      <div className="px-2 py-1 lg:col-span-4 2xl:col-span-2 lg:mx-4  lg:relative">
        <h1 className="text-center text-2xl font-bold text-gray-800 mt-3 lg:text-justify">
          {name}
        </h1>
        <pre className="line-clamp-3 text-lg font-light my-2 text-gray-700">
          {description}
        </pre>
        <div className="lg:absolute lg:w-full lg:flex justify-between lg:bottom-0 lg:left-0 lg:mx-1">
          <p className="text-center text-xl font-semibold text-gray-800 lg:inline-block lg:order-2 lg:self-center">
            Price:- {price}
          </p>
          <div
            className="bg-indigo-500 font-semibold text-center text-gray-50 px-4 py-2 rounded-full shadow-xl my-2 lg:inline-block lg:order-1"
            onClick={addToCart}
          >
            {count !== 0 ? (
          ...
          <div className="bg-indigo-500 text-center font-semibold text-gray-50 px-4 py-2 rounded-full shadow-xl my-2 lg:inline-block lg:order-3">
